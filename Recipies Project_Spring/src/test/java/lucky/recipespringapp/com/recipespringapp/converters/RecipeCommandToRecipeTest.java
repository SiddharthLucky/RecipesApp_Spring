...
public class RecipeCommandToRecipeTest {
    ...
    public void convert() throws Exception {
        ...
        assertEquals(java.util.Optional.ofNullable(COOK_TIME), recipe.getCookTime());
        assertEquals(java.util.Optional.ofNullable(PREP_TIME), recipe.getPrepTime());
        assertEquals(DESCRIPTION, recipe.getDescription());
        assertEquals(DIFFICULTY, recipe.getDifficulty());
        assertEquals(DIRECTIONS, recipe.getDirections());
        assertEquals(java.util.Optional.ofNullable(SERVINGS), recipe.getServings());
