...
public class RecipeToRecipeCommandTest {
    ...
    public void convert() throws Exception {
        ...
        assertEquals(java.util.Optional.ofNullable(COOK_TIME), command.getCookTime());
        assertEquals(java.util.Optional.ofNullable(PREP_TIME), command.getPrepTime());
        assertEquals(DESCRIPTION, command.getDescription());
        assertEquals(DIFFICULTY, command.getDifficulty());
        assertEquals(DIRECTIONS, command.getDirections());
        assertEquals(java.util.Optional.ofNullable(SERVINGS), command.getServings());
